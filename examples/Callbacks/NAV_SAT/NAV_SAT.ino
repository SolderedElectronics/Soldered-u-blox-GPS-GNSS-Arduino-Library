 ...
 **************************************************
 * @file        NAV_SAT.ino
 * @brief       Receive NAV-SAT satellite information reports automatically using a callback.
 *
 * @details     This example configures the GNSS to produce NAV-SAT messages at 1 Hz
 *              and registers a callback that prints the number of tracked SVs and
 *              draws a signal-strength bar chart for each satellite.
 *
 * Requirements:
 * - Board:      Any Arduino-compatible board with I2C
 * - Hardware:   Any u-blox GNSS module (e.g. ZED-F9P)
 *
 * How to use:
 ...
 *
 * Expected output:
 * - Number of tracked SVs and a bar chart of signal strength (C/N0) for each
 *   satellite, printed each second.
 *
