 ...
 **************************************************
 * @file        NAV_ODO.ino
 * @brief       Configure the GNSS odometer and display NAV-ODO distance data using a callback.
 *
 * @details     This example enables the u-blox GNSS odometer (NAV-ODO) with the car
 *              profile and registers a callback to print the time-of-week, trip
 *              distance and total distance automatically each navigation cycle.
 *              The odometer configuration is read, modified and written back using
 *              getOdometerConfig / setOdometerConfig.
 *
 * Requirements:
 ...
 *
 * Expected output:
 * - Time Of Week (ms), trip distance (m) and total distance (m) printed each second.
 *
