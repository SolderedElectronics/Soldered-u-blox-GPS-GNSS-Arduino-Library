/**
 **************************************************
 * @file        RXM_without_Callbacks.ino
 * @brief       Log RXM SFRBX and RAWX data to SD card without using callbacks.
 *
 * @details     Configures the u-blox GNSS to send RXM SFRBX and RAWX reports
 *              automatically over I2C and logs the raw UBX data to an SD card
 *              without using callbacks. Data is polled directly via
 *              checkUblox() and buffered in a 16 KB RAM buffer before being
 *              written to the SD card in 512-byte blocks. Suitable for
