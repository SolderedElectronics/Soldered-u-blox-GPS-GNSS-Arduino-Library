 ...
 **************************************************
 * @file        NAV_PVT.ino
 * @brief       Log NAV PVT messages to SD card in UBX format using a callback.
 *
 * @details     Configures the u-blox GNSS to send NAV PVT reports automatically
 *              over I2C and logs the raw UBX packets to an SD card file. A
 *              callback prints time, latitude, longitude, and height above MSL
 *              to the Serial Monitor while logging proceeds. Data can be
 *              replayed and analyzed with u-center.
 *
 * Requirements:
 ...
 *
 * Expected output:
 * - Time, latitude, longitude, and height above MSL printed once per second.
 ...
 * - Data is logged in UBX format; use u-center to replay and analyze.
 *
