 ...
 **************************************************
 * @file        NMEA.ino
 * @brief       Log NMEA sentences and UBX NAV PVT data simultaneously to SD card.
 *
 * @details     Configures the u-blox GNSS to output both UBX NAV PVT and selected
 *              NMEA messages (GGA, GSA, GSV) over I2C, then logs all of them to
 *              an SD card in a buffered file. Bytes written are reported to the
 *              Serial Monitor once per second. The sketch requires a processor
 *              with sufficient RAM to hold the 16 KB file buffer.
 *
 * Requirements:
 * - Board:      Any Arduino-compatible board with I2C, SPI, and ample RAM
 * - Hardware:   u-blox GNSS module (e.g. NEO-M8, ZED-F9P)
 * - Extra:      SD card
 *
 * How to use:
