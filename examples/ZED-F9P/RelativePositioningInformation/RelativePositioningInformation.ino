/**
 **************************************************
 * @file        RelativePositioningInformation.ino
 * @brief       Read relative position (NED frame) from a ZED-F9P rover.
 *
 * @details     Queries the module for relative positioning information in the
 *              North-East-Down frame, intended for RTK use where correction
 *              data is already available. Optionally forwards RTCM bytes from
 *              Serial1 to the module over I2C for rover operation.
 *
 * Requirements:
 * - Board:      Any Arduino-compatible board with I2C
 * - Hardware:   u-blox ZED-F9P with RTCM corrections available
 *
 * How to use:
 * 1) Connect the u-blox module to your board via I2C.
 * 2) Provide RTCM corrections (optionally via Serial1 pass-through).
 * 3) Upload the sketch and open Serial Monitor at 115200 baud.
 *
 * Expected output:
 * - Relative N/E/D position components and related RTK status information.
 *
