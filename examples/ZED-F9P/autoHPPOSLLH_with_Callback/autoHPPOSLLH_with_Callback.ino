/**
 **************************************************
 * @file        autoHPPOSLLH_with_Callback.ino
 * @brief       Enable automatic HPPOSLLH reports and process them with a callback.
 *
 * @details     Configures automatic NAV-HPPOSLLH output and attaches a callback
 *              that runs whenever new data arrives, eliminating manual polling.
 *              Demonstrates event-driven high-precision position handling over
 *              I2C for cleaner and more responsive application code.
 *
 * Requirements:
 ...
 *
 * Expected output:
 * - Callback-driven high-precision latitude/longitude/altitude updates printed
 *   as new HPPOSLLH packets arrive.
 *
