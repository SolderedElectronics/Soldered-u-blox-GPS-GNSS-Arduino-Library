/**
 **************************************************
 * @file        NTRIPClient.ino
 * @brief       Connect to an NTRIP caster over WiFi and push RTCM corrections to a ZED-F9x.
 *
 * @details     Uses ESP32 WiFi to connect to RTK2Go as an NTRIP Rev1 client,
 *              receives RTCM correction data, and forwards it over I2C to a
 *              ZED-F9x to achieve RTK-level accuracy. Reconnects automatically
 *              if no RTCM data is received within 10 s. WiFi credentials and
 *              NTRIP mountpoint details must be placed in secrets.h.
 *
 * Requirements:
 ...
 * - NTRIP connection status and bytes received from the caster.
 * - RTK fix type improvement visible in navigation output.
 *
