/**
 **************************************************
 * @file        GetHighPrecisionPositionAndAccuracy.ino
 * @brief       Read high-precision geodetic position and horizontal/vertical accuracy.
 *
 * @details     Reads the high-precision HPPOSLLH solution from the ZED-F9P at
 *              up to 20 Hz and prints latitude, longitude, altitude, and the
 *              horizontal and vertical accuracy estimates. Demonstrates how to
 *              combine the standard and high-precision integer components to
 *              reconstruct the full sub-millimetre position.
 *
 * Requirements:
 ...
 *
 * Expected output:
 * - Latitude, longitude (degrees * 10^-7 + high-precision fraction),
 *   altitude (mm), horizontal accuracy (mm), vertical accuracy (mm).
 *
