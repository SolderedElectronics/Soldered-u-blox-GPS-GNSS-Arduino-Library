/**
 **************************************************
 * @file        StartRTCMBase.ino
 * @brief       Configure a ZED-F9P as an RTK base station and start RTCM output.
 *
 * @details     Performs full base-station setup: starts Survey-In, waits for
 *              target survey accuracy and duration, enables RTCM message output,
 *              and begins streaming correction data. Optionally mirrors RTCM
 *              bytes to Serial1 for external radios or telemetry links.
 *
 * Requirements:
 ...
 *
 * Expected output:
 * - Survey-In progress, completion notification, and RTCM enable/status output.
 *
